...
img = cv.imread("/Users/arhan.sheth/Documents/Codes/DX/Basics/dx_opencvInitial/ImageProcessing/cages.png")
assert img is not None, "file could not be read, check with os.path.exists()"
ogImage = img.copy()
imgray = cv.cvtColor(img, cv.COLOR_BGR2GRAY)
ret, thresh = cv.threshold(imgray, 140, 255, 0)
ret2, thresh2 = cv.threshold(imgray, 140, 255, cv.THRESH_BINARY_INV + cv.THRESH_OTSU)
